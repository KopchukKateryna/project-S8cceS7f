...
class NotesBook(UserDict):
    ...
    def add_tag(self, note_name, tag) -> str:
        ...
        Returns:
            str: The result of adding the tag, either a success message or
            an error message indicating that the note was not found.

        Notes:
            If the note is found, this method delegates to the note's `add_tag` method.
            If the note is not found, returns an error message
    ...
    def add_tags(self, note_name, tags: str) -> str:
        ...
        Returns:
            str: A success message if the tags are added,
            or an error message if the note is not found.
        """
        note = self.find(note_name)
        if note:
    ...
    def edit_tag(self, note_name, old_tag, new_tag) -> str:
        ...
        Returns:
            str: A success message if the tag is edited, or an error
            message if the note is not found.
        """
        note = self.find(note_name)
        if note:
    ...
    def remove_tag(self, note_name, tag) -> str:
        ...
        Returns:
            str: A success message if the tag is removed, or an error
            message if the note is not found.
        """
        note = self.find(note_name)
        if note:
    ...
    def remove_tags(self, note_name, tags: str) -> str:
        ...
        Returns:
            str: A success message if the tags are removed, or an error
            message if the note is not found.
        """
        note = self.find(note_name)
        if note:
    ...
    def find_note_tags(self, note_name) -> str:
        ...
        Returns:
            str: A string of all tags in the note, or an error
            message if the note is not found.
        """
        note = self.find(note_name)
        if note:
