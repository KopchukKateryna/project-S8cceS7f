...
from helpers.autocomplete_config import bindings_general, bindings_for_contact,bindings_for_add_edit_delete,bindings_for_edit_delete,bindings_for_name_text
